        ...
        if (snapshot.hasData && snapshot.data!.docs.isNotEmpty) {
          for (var doc in snapshot.data!.docs) {
            ...
            if (data['timestamp'] != null) {
              ...
              // Jika absen di atas atau sama dengan jam 9, hitung sebagai terlambat
              if (date.hour >= 9) {
                totalTerlambat++;
              }
            }
              ...
              children: [
                  ...
                  child: const Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            'Area Penugasan Kerja',
                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF0B2F64)),
                          ),
                          Text(
                            'Sistem GPS Terbuka Aktif',
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      await FirebaseFirestore.instance
                        ...
                        "message": "Silakan lakukan presensi hari ini",
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Colors.white,
                        border: Border.all(color: const Color(0xFF006B5E).withOpacity(0.2), width: 10),
                      ),
                      child: Center(
                        child: Container(
                          width: 160,
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start, // <--- Ini bagian yang terpotong sebelumnya
                      children: [
                        Row(
